    ...
    <>
      ...
      <section className="bg-kp-white py-20 md:py-28">
        <div className="mx-auto max-w-5xl px-6 grid grid-cols-1 md:grid-cols-[260px_1fr] gap-12 items-start">
          <div>
            <div className="aspect-[4/5] rounded-2xl overflow-hidden bg-kp-green-100 mb-4 shadow-lg">
            ...
            {about?.founder_title && (
              <p className="text-sm text-kp-black/60">{about.founder_title}</p>
            )}
          </div>

          <div>
            {about?.mission_statement && (
              <blockquote className="border-l-4 border-kp-gold-500 pl-6 py-2 mb-10 font-serif text-xl text-kp-green-900 italic">
                {about.mission_statement}
              </blockquote>
            )}
            <div
